...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.stores.user_attempts.driver' => 'string',
            'cache.stores.user_attempts.connection' => 'string',
            'cache.stores.user_attempts.lock_connection' => 'string',
            'cache.prefix' => 'string',
            ...
            'database.redis.user_attempts.url' => 'NULL',
            'database.redis.user_attempts.host' => 'string',
            'database.redis.user_attempts.username' => 'NULL',
            'database.redis.user_attempts.password' => 'NULL',
            'database.redis.user_attempts.port' => 'string',
            'database.redis.user_attempts.database' => 'string',
            ...
            'filesystems.links.C:\Users\mb\project me\example-app\public\storage' => 'string',
            'jwt.secret' => 'string',
...
'cache.stores.dynamodb.region','cache.stores.dynamodb.table','cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.stores.user_attempts.driver',
'cache.stores.user_attempts.connection','cache.stores.user_attempts.lock_connection','cache.prefix','data.date_format','data.date_timezone',
...
'database.redis.cache.database','database.redis.user_attempts.url','database.redis.user_attempts.host','database.redis.user_attempts.username','database.redis.user_attempts.password',
'database.redis.user_attempts.port','database.redis.user_attempts.database','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\mb\\project me\\example-app\\public\\storage',
...
'jwt.providers.auth','jwt.providers.storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api',
...
'signed','throttle','verified','Ratelimit','AuthMiddleware',);
...
'books.index','books.create','books.store','books.show','books.edit',
'books.update','books.destroy','generated::0a1dhUHMU61VpLL7','generated::5tRmJkeTYfkjEunO','generated::oUQJt5Wv5gO6MBvJ',
'generated::MEH5Qx2LNFM9iw6i','generated::CjlWivjW1V5Xmkfv','storage.local',);
...
'APP_URL','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','APP_LOCALE',
...
'REDIS_DB','REDIS_CACHE_DB','REDIS_USER_ATTEMPTS_DB','MAIL_MAILER','MAIL_SCHEME',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','JWT_SECRET',);
